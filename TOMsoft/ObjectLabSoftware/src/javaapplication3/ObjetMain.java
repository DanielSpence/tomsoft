 ...
 * @author Matt
 */
public class ObjetMain extends javax.swing.JFrame {
    ...
    private void NewBuildButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NewBuildButtonActionPerformed
        // TODO add your handling code here:
        ResultSet res = ObjetMain.dba.searchPrinterSettings("objet");
        double Price = 0;
        try {
            if (res.next()) {
    ...
    private void OpenBuildsButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OpenBuildsButtonActionPerformed
        // TODO add your handling code here:
        OBuild.ZcorpOpenBuildsStart("Objet");
        OBuild.OpenBuildsHeader.setText("Objet Open Builds");
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        try {
            Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler " + ObjetMain.getInstance().getPDF());
        } catch (IOException e) {
