...
public class Student_Submission extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(Browse, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 60, 70, -1));
        ...
        Student_Submit.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        Student_Submit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Student_SubmitActionPerformed(evt);
            }
        });
        getContentPane().add(Student_Submit, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 301, 60, 21));

        classBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "ART 101", "ART 225" }));
        classBox.setSelectedItem(null);
        getContentPane().add(classBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 210, 85, -1));
        ...
        getContentPane().add(printerBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 240, 90, -1));
